      ...
      <div className="profile-area">
        <div className="profile-information-box">
          ...
          <div className="profile-notification-box">
            <ul>
              <li>
                Müraciət edənlər: <span>0</span>
              </li>
              <li>
                Yaradan tenderler: <span>0</span>
              </li>
              <li>
                Sorğu: <span>0</span>
              </li>
        ...
        {!showCreateTender ? (
          <div className="profile-control-box">
            <ul className="profile-tabs">
              ...
              <li
                className={`profile-tab ${activeTab === 3 ? "active" : ""}`}
                onClick={() => handleTabClick(3)}
              >
                Tab 3
              </li>
              <button className="profile-add-tender" onClick={handleNavigate}>
                Tender əlavə et
              </button>
            </ul>
            <div className="profile-content-tabs">
              <div
                className={
                  activeTab === 1 ? "profile-active-content" : "profile-content"
                }
              >
                <h2>Lorem ipsum dolor sit amet.</h2>
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Repudiandae explicabo sint, autem quisquam alias accusamus
                  tenetur eos velit porro cumque.
                </p>
              </div>
              <div
                className={
                  activeTab === 2 ? "profile-active-content" : "profile-content"
                }
              >
                <h2>Lorem ipsum dolor sit amet.</h2>
                <p>
              ...
              <div
                className={
                  activeTab === 3 ? "profile-active-content" : "profile-content"
                }
              >
                <h2>Lorem ipsum dolor sit amet.</h2>
                <p>
                  Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Reiciendis asperiores, sit illo ipsa fugiat facilis.
                </p>
              </div>
            </div>
          </div>
